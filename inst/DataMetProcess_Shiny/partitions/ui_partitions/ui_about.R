  ...
  tagList(
    fluidRow(
      ...
      tags$section(
        ...
        tags$h3("Citation"),
        tags$p("
               Santos, W. M. et al.(2025). DataMetProcess: An open-source package and Shiny application for the acquisition and processing of meteorological data from INMET....
               "),
        tags$h3("Contacts"),
        tags$p("
